    ...
    _this.registerContainerRef = function (n) {
      ...
      if (n) {
        ...
        if (_this.scrollPane === window) {
          ...
          _this.rosp = new _resizeObserverPolyfill.default(_this.handleScrollPaneResize);
        ...
        _this.ropn = new _resizeObserverPolyfill.default(_this.handleParentNodeResize);

        _this.ropn.observe(_this.node.parentNode);

        _this.handleParentNodeResize();

        _this.ron = new _resizeObserverPolyfill.default(_this.handleNodeResize);
