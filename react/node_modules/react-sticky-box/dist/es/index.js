    ...
    _this.registerContainerRef = function (n) {
      ...
      if (n) {
        ...
        if (_this.scrollPane === window) {
          ...
          _this.rosp = new ResizeObserver(_this.handleScrollPaneResize);
        ...
        _this.ropn = new ResizeObserver(_this.handleParentNodeResize);

        _this.ropn.observe(_this.node.parentNode);

        _this.handleParentNodeResize();

        _this.ron = new ResizeObserver(_this.handleNodeResize);
